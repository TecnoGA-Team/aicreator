...
export default function ThemeToggle() {
    const {theme,changeTheme}:any=useContext(ThemeContext)
        ...
        return (
            <div   className=" flex  flex-col   items-start w-[35px] h-[35px] overflow-hidden">

                <style jsx>{`

                    ${ (theme=='dark') ? '.moonbtn {  height: 0px; width: 0px;}' : '.moonbtn {height: 25px ; width: 25px ;}' }
                    ${ (theme=='dark') ? '.sunbtn {height: 25px; width: 25px;}' : '.sunbtn { height: 0px ; width: 0px ;}' }
                ...
                <ul>
                    <li>
                        <button type="button" className='flex sunbtn colorGA  transition-opacityme ' 
                    ...
                    <li>
                    <button type="button" className='flex moonbtn colorGA transition-opacityme '  
