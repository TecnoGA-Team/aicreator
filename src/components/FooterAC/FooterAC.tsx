...
import './styleFooterAC.css';
import logoAC from '@/assets/imgs/logo/logo-AC-1.png';
import TextAnimation1 from '../compo/textAnimation/TextAnimation1/TextAnimation1';
import data from '@/assets/json/DataNavbar.json'
import LinkAC from '../compo/LinkAC/LinkAC';

export default function FooterAC() {
    const {theme}: any = useContext(ThemeContext);
    const {lang}: any = useContext(LangContext);
    const Datafooter=(lang=='Ar')?data.ar:(lang=='En')?data.en:data.tr;
        ...
        <div>
            ...
            <div className="footer">
                <div className="container">
                    ...
                    <div className="box">
                    <ul className="links">
                        <li> <LinkAC text= {Datafooter.navAbout.title} href='/AboutPage' cn='' > </LinkAC></li>
                        <li><LinkAC  text={Datafooter.navOurBusiness.title} href='/#Business' cn='' ></LinkAC></li>
                        <li> <LinkAC href='/GalleryPage' text={Datafooter.navGallery.title}  cn=''></LinkAC></li>
                    ...
                    <div className="line">
                        ...
                        <div className="info">Türkiye,Bursa,Inside Yalova Street,building number 224</div>
                    </div>
                    <div className="line">
                        <i className="far fa-clock fa-fw"></i>
                        <div className="info">Business Hours: From 10:00 To 22:00</div>
                    </div>

                    </div>

                </div>
                <p className="copyright">Made With &lt;AI CREAT</p>
            </div>
